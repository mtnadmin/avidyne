...
function portfolio_register()
{
	...
	$labels = array(
		'name' => _x('Products', 'post type general name','avia_framework'),
		'singular_name' => _x('Product Entry', 'post type singular name','avia_framework'),
		'add_new' => _x('Add New', 'portfolio','avia_framework'),
		'add_new_item' => __('Add New Product','avia_framework'),
		'edit_item' => __('Edit Product','avia_framework'),
		'new_item' => __('New Product','avia_framework'),
		'view_item' => __('View Product Entry','avia_framework'),
		'search_items' => __('Search Products','avia_framework'),
		'not_found' =>  __('No Products found','avia_framework'),
		'not_found_in_trash' => __('No Products found in Trash','avia_framework'),
		'parent_item_colon' => ''
	);
