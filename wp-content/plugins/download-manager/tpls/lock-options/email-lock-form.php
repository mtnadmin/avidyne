...
<form id="<?php echo $form_id; ?>" class="<?php echo $form_id; ?>" method=post action="<?php echo home_url('/'); ?>" style="font-weight:normal;font-size:12px;padding:0px;margin:0px">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <input type="email" required="required" class="form-control group-item email-lock-mail" placeholder="'.$eeml.'" size="20" id="email_<?php echo $field_id; ?>" name="email" style="margin:5px 0" />
