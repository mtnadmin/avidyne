    ...
    <?php if(is_user_logged_in()){
        ...
        <form name="loginform" id="loginform" action="" method="post" class="login-form" >
            ...
            <div class="row">
                ...
                <?php if($regurl != ''){ ?>
                <div class="col-md-12"><br/><a href="<?php echo $regurl; ?>" name="wp-submit" id="loginform-submit" class="btn btn-block btn-link btn-xs wpdm-reg-link color-green"><?php _e( "Don't have an account yet?" , "download-manager" ); ?> <i class="fas fa-user-plus"></i> <?php _e( "Register Now" , "download-manager" ); ?></a></div>
                <?php } ?>
            </div>
