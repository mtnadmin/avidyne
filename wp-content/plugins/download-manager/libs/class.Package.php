...
class Package {
    ...
    function Prepare($ID = null, $template = null, $template_type = 'page')
    {
        ...
        $post_vars['download_link'] = (int)get_option('__wpdm_mask_dlink', 1) == 1?"<a class='wpdm-download-link {$post_vars['btnclass']}' rel='nofollow' href='#' onclick=\"this.href='{$post_vars['download_url']}';\">{$post_vars['link_label']}</a>":"<a class='wpdm-download-link {$post_vars['btnclass']}' rel='nofollow' href='{$post_vars['download_url']}'>{$post_vars['link_label']}</a>";
