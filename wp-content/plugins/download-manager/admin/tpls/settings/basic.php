 ...
 <div class="panel panel-default">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label for="__wpdm_download_limit_exceeded"><?php echo __( "Permission Denied Message for Packages:" , "download-manager" ); ?></label>
                                <textarea id="__wpdm_download_limit_exceeded" name="__wpdm_download_limit_exceeded" class="form-control"><?php echo stripslashes(get_option('wpdm_permission_msg'));?></textarea>
                         </div>
